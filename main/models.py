...
class User(UserMixin, db.Model):
    ...
    # Relationship for assigned items
    allocated_items = db.relationship('Item', foreign_keys='Item.assigned_expert_id', backref='assigned_expert', lazy=True)
...
class Item(db.Model):
    ...
    # Category field for expert allocation
    #category = db.Column(db.String(100), nullable=False)

    # Expert assignment field
    #assigned_expert_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=True)
    #assigned_expert = db.relationship('User', foreign_keys=[assigned_expert_id], backref='allocated_items')    
